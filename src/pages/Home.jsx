        ...
        <div className="min-h-screen w-screen bg-white">
            ...
            <section className="px-6 lg:px-20 py-16 bg-gray-50">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <img src={register} alt="Register" className="mx-auto w-24 h-24 mb-4"/>
                        <h3 className="text-xl font-bold text-gray-800">Register</h3>
                        <p className="text-gray-600">Sign up online or at your nearest blood donation camp.</p>
                    </div>
                    <div className="text-center">
                        <img src={donate} alt="Donate" className="mx-auto w-24 h-24 mb-4"/>
                        <h3 className="text-xl font-bold text-gray-800">Donate</h3>
                        <p className="text-gray-600">Attend the scheduled appointment and donate blood.</p>
                    </div>
                    <div className="text-center">
                        <img src={thankyou} alt="Thank You" className="mx-auto w-24 h-24 mb-4"/>
                        <h3 className="text-xl font-bold text-gray-800">Save Lives</h3>
                        <p className="text-gray-600">Your blood helps save lives and brings hope to many families.</p>
                    </div>
                </div>
            </section>
                ...
                <div className="w-full lg:w-3/4 mx-auto">
                    <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                        <p className="text-lg text-gray-700 italic mb-4">
                            "Donating blood was one of the most fulfilling experiences I've ever had. Knowing that I could help save a life gives me a sense of purpose."
                        </p>
